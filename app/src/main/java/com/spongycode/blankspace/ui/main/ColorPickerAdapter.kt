...
import com.spongycode.blankspace.ui.main.ColorPickerAdapter.ViewHolder
import java.util.*


internal class ColorPickerAdapter internal constructor(private var context: Context, colorPickerColors: List<Int>) :
        RecyclerView.Adapter<ViewHolder>() {
    private var inflater: LayoutInflater
    private val colorPickerColors: List<Int>
    private var onColorPickerClickListener: ColorPickerAdapter.OnColorPickerClickListener? = null

    internal constructor(context: Context) : this(context, ColorPickerAdapter.Companion.getDefaultColors(context)) {
    ...
    fun setOnColorPickerClickListener(onColorPickerClickListener: ColorPickerAdapter.OnColorPickerClickListener?) {
    ...
    internal inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            itemView.setOnClickListener { onColorPickerClickListener?.onColorPickerClickListener(colorPickerColors[adapterPosition]) }
        }
    }
