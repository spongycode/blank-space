package com.spongycode.blankspace.ui.edit.fragments
...
import com.spongycode.blankspace.ui.edit.adapters.ColorPickerAdapter
...
class PropertiesBSFragment : BottomSheetDialogFragment(), OnSeekBarChangeListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val colorPickerAdapter = ColorPickerAdapter(context as Context)
